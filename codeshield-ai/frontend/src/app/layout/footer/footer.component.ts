...
export class FooterComponent {
  ...
  productLinks = [
    { label: 'Code Reviewer', route: '/reviewer' },
  ...
  resourceLinks = [
    { label: 'GitHub', href: 'https://github.com/Rutik2401/codeshield-ai' },
    { label: 'Documentation', href: 'https://github.com/Rutik2401/codeshield-ai#readme' },
    { label: 'Changelog', href: 'https://github.com/Rutik2401/codeshield-ai/releases' },
  ];
